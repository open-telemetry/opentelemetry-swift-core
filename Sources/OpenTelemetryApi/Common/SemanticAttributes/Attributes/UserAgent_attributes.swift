  ...
  enum UserAgent: String {
    ...
    */
    ...
    /**
     ...
     - Requires: Value should be one of [`/output/Attributes/UserAgent_attributes.swift.UserAgentSyntheticTypeValues`](x-source-tag://otelUserAgentSyntheticTypeValues) (of type `String`)
    */
