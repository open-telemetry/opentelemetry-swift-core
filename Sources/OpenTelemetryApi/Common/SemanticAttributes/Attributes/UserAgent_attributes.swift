  ...
  public enum UserAgent: String {
    ...
    */
    ...
    /**
     ...
     - Requires: Value should be one of [`SemanticContentions.UserAgent.SyntheticTypeValues`](x-source-tag://SemanticConventions.user_agent.SyntheticTypeValues) (of type `String`)
    */
    ...
    */
    ...
    /** 
      Specifies the category of synthetic traffic, such as tests or bots.
    */
    /// - Tag: SemanticConventions.UserAgent.SyntheticTypeValues
