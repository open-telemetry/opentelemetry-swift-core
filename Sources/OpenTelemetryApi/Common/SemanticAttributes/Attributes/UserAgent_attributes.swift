  ...
  enum UserAgent: String {
    ...
    */
    ...
    /**
     ...
     - Requires: Value should be one of [`/output/Attributes/UserAgent_attributes.swift.SyntheticTypeValues`](x-source-tag://otelSyntheticTypeValues) (of type `String`)
    */
