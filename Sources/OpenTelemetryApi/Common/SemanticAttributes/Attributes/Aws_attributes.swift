  ...
  enum Aws: String {
    ...
    */
    ...
    /**
     ...
     - Requires: Value should be one of [`/output/Attributes/Aws_attributes.swift.EcsLaunchtypeValues`](x-source-tag://otelEcsLaunchtypeValues) (of type `String`)
    */
